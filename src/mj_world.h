...
// the runtime is compiled and shipped as part of this GDExtension.
...
public:
	...
	void set_qpos(const PackedFloat64Array &values);
	PackedFloat64Array get_qvel() const;
	void set_qvel(const PackedFloat64Array &values);
